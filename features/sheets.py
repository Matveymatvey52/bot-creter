# FEATURE: sheets
# COMPATIBLE_WITH: accountant, booking_beauty, booking_fitness, booking_medical, booking_restaurant, campaign_tracker, car_rental, course_tracker, coworking_space, debtors, delivery_tracker, event_manager, event_rsvp, expense_tracker, feedback_survey, food_delivery, habit_tracker, inventory, loyalty_program, manager_secretary, moderator, orders_tracker, property_rental, referral_program, rental_equipment, repair_tracker, shop_catalog, staff_scheduler, support_tickets, tourist_documents, trip_manager, vehicle_service
