    ...
    "resources": [
        {
            ...
            "fields": [
                ...
                {"name": "date_end", "label": "Окончание", "kind": "date", "list": True, "detail": True, "create": True},
        ...
        },
        {
            ...
            "fields": [
                ...
                {"name": "date", "label": "Дата", "kind": "date", "list": True, "detail": True, "create": True},
        ...
        },
        {
            ...
            "fields": [
                {"name": "tour_id", "required": True, "label": "Тур", "kind": "number", "list": False, "detail": True, "create": True, "ref": {"resource": "tours", "labelField": "name"}},
                {"name": "name", "required": True, "label": "Имя гостя", "kind": "text", "list": True, "detail": False, "create": True},
                {"name": "total_cost", "label": "Стоимость", "kind": "number", "list": True, "detail": True, "create": True},
                {"name": "prepaid", "label": "Предоплата", "kind": "number", "list": True, "detail": True, "create": True},
        ...
        },
        {
            ...
            "fields": [
                ...
                {"name": "description", "label": "Описание", "kind": "text", "list": True, "detail": False, "create": True},
                {"name": "entity", "label": "Контрагент", "kind": "text", "list": True, "detail": True, "create": True},
                {"name": "date", "label": "Дата", "kind": "date", "list": True, "detail": True, "create": True},
                {"name": "created_at", "creatable": False, "label": "Создано", "kind": "date", "list": False, "detail": False, "create": False},
            ],
        },
