...
def _is_bot_admin(user_id: int, config: "BookingBeautyConfig") -> bool:
...
# slots are auto-generated by _ensure_slots() on a rolling window, not
# hand-created by the owner — not creatable here. bookings are what the
# owner actually manages day-to-day (mirrors 🗂 Все записи / 📅 Записаться).
miniapp_config = {
    "resources": [
        {
            "name": "slots",
            ...
            "fields": [
                ...
                {"name": "master", "label": "Мастер", "kind": "text", "list": True, "detail": True, "create": False},
                {"name": "service", "label": "Услуга", "kind": "text", "list": False, "detail": True, "create": False},
                {"name": "price", "label": "Цена", "kind": "number", "list": False, "detail": True, "create": False},
