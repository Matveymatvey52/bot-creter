...
class DiscoverTemplatesRegressionOnRealTemplates(unittest.TestCase):
    ...
    booking_restaurant, repair_tracker, and coworking_space were each added
    after this test was first written — every new template added purely by
