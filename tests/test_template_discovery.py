...
class DiscoverTemplatesRegressionOnRealTemplates(unittest.TestCase):
    ...
    def test_all_real_templates_are_discovered(self):
        ...
        self.assertEqual(
            names,
            {"accountant", "booking_beauty", "booking_fitness", "booking_medical", "campaign_tracker", "inventory", "manager_secretary", "moderator", "referral_program", "shop_catalog", "tour_operator", "tourist_documents", "trip_manager"},
        )
    ...
    def test_prompt_lists_all_real_templates(self):
        prompt = claude_service._build_template_select_prompt()
        for name in ("accountant", "booking_beauty", "booking_fitness", "booking_medical", "campaign_tracker", "inventory", "manager_secretary", "moderator", "referral_program", "shop_catalog", "tour_operator", "tourist_documents", "trip_manager"):
