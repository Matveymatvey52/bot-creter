...
# userbot (Telethon Client API) — channel_monitor feature. Deliberately
...
# API_HASH identify the application making the connection. Shared across
# every bot's channel_monitor session (one registered Telegram application
# for the whole factory) — see docs/USERBOT_FEATURE_DESIGN.md §6 q5. See
# docs/USERBOT_CHANNEL_MONITOR_DESIGN.md §1 for the encryption rationale.
